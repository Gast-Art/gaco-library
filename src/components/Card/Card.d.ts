...
export declare const CardSections: {
    ...
    Actions: import('styled-components/dist/types').IStyledComponentBase<"web", import('styled-components').FastOmit<import('styled-components').FastOmit<import('../../../node_modules/react').DetailedHTMLProps<import('../../../node_modules/react').HTMLAttributes<HTMLDivElement>, HTMLDivElement>, never>, never>> & string;
};
interface CardProps extends PropsWithChildren {
    className?: string;
    style?: CSSProperties;
