import{j as e}from"./jsx-runtime-CLpGMVip.js";import{C as T}from"./Card-CzlKs6Iz.js";import{T as l}from"./TooltipChart-DT8CKmlW.js";import{g as b,B as p,f as h,R as f,T as v,L as j}from"./generateCategoricalChart-DsdBGqja.js";import{X as m,Y as d,C as A}from"./YAxis-F1iB6ohs.js";import"./index-CXuOLBzL.js";import"./styled-components.browser.esm-C1W4bV5D.js";import"./light-CHoHqcPY.js";import"./media-BNrmHCp5.js";import"./ButtonGroup-CvIbIvT2.js";import"./LoadingOverlay-C5RFO-D0.js";import"./Spinner-C6ovFptS.js";import"./info-PhLFfq1i.js";import"./createLucideIcon-Bcs7-Zr2.js";import"./Typography-CQ9hZxbj.js";import"./tiny-invariant-CopsF_GD.js";var S=b({chartName:"BarChart",GraphicalChild:p,defaultTooltipEventType:"axis",validateTooltipEventTypes:["axis","item"],axisComponents:[{axisType:"xAxis",AxisComp:m},{axisType:"yAxis",AxisComp:d}],formatAxisMap:h});const u=({data:a,labels:r,height:c=400,hideLegend:y,tooltipContent:C=l})=>e.jsx(f,{width:"100%",height:c,children:e.jsxs(S,{data:a,children:[e.jsx(A,{strokeDasharray:"3 3"}),e.jsx(m,{dataKey:"name"}),e.jsx(d,{}),e.jsx(v,{content:C}),!y&&e.jsx(j,{}),r.map(({dataKey:n,label:x,color:g})=>e.jsx(p,{dataKey:n,name:x,fill:g},n))]})});u.__docgenInfo={description:"",methods:[],displayName:"BarChart",props:{data:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:"{ [key: string]: any }",signature:{properties:[{key:{name:"string"},value:{name:"any",required:!0}}]}}],raw:"{ [key: string]: any }[]"},description:""},labels:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:"{ dataKey: string; label: string; color: string }",signature:{properties:[{key:"dataKey",value:{name:"string",required:!0}},{key:"label",value:{name:"string",required:!0}},{key:"color",value:{name:"string",required:!0}}]}}],raw:"{ dataKey: string; label: string; color: string }[]"},description:""},tooltipContent:{required:!1,tsType:{name:"ContentType",elements:[{name:"ValueType"},{name:"NameType"}],raw:"ContentType<ValueType, NameType>"},description:"",defaultValue:{value:`({ active, payload, label, tooltipValueFormatter = (label) => label.toString(), children }: TooltipChartProps) => {
  if (active) {
    return (
...
}`,...(i=(o=t.parameters)==null?void 0:o.docs)==null?void 0:i.source}}};const J=["Default"];export{t as Default,J as __namedExportsOrder,G as default};
