import{j as s}from"./jsx-runtime-CLpGMVip.js";import{r as v}from"./index-CR__hKHy.js";import{c as J,a as M,u as Q,b as U,d as W,P as w,R as X,I as Y,e as y,f as Z}from"./index-bxkApRut.js";import{d as C,l as x}from"./styled-components.browser.esm-DnH8uv-2.js";import"./light-SvT5IF7k.js";import{m as ee}from"./media-BIK856jo.js";import"./index-D2e_E8nu.js";import"./index-CtmzRm2p.js";var S="Tabs",[se,ge]=J(S,[M]),k=M(),[re,I]=se(S),D=v.forwardRef((e,r)=>{const{__scopeTabs:o,value:a,onValueChange:i,defaultValue:d,orientation:t="horizontal",dir:u,activationMode:T="automatic",...f}=e,l=Q(u),[n,b]=U({prop:a,onChange:i,defaultProp:d});return s.jsx(re,{scope:o,baseId:W(),value:n,onValueChange:b,orientation:t,dir:l,activationMode:T,children:s.jsx(w.div,{dir:l,"data-orientation":t,...f,ref:r})})});D.displayName=S;var F="TabsList",O=v.forwardRef((e,r)=>{const{__scopeTabs:o,loop:a=!0,...i}=e,d=I(F,o),t=k(o);return s.jsx(X,{asChild:!0,...t,orientation:d.orientation,dir:d.dir,loop:a,children:s.jsx(w.div,{role:"tablist","aria-orientation":d.orientation,...i,ref:r})})});O.displayName=F;var G="TabsTrigger",q=v.forwardRef((e,r)=>{const{__scopeTabs:o,value:a,disabled:i=!1,...d}=e,t=I(G,o),u=k(o),T=K(t.baseId,a),f=H(t.baseId,a),l=a===t.value;return s.jsx(Y,{asChild:!0,...u,focusable:!i,active:l,children:s.jsx(w.button,{type:"button",role:"tab","aria-selected":l,"aria-controls":f,"data-state":l?"active":"inactive","data-disabled":i?"":void 0,disabled:i,id:T,...d,ref:r,onMouseDown:y(e.onMouseDown,n=>{!i&&n.button===0&&n.ctrlKey===!1?t.onValueChange(a):n.preventDefault()}),onKeyDown:y(e.onKeyDown,n=>{[" ","Enter"].includes(n.key)&&t.onValueChange(a)}),onFocus:y(e.onFocus,()=>{const n=t.activationMode!=="manual";!l&&!i&&n&&t.onValueChange(a)})})})});q.displayName=G;var B="TabsContent",g=v.forwardRef((e,r)=>{const{__scopeTabs:o,value:a,forceMount:i,children:d,...t}=e,u=I(B,o),T=K(u.baseId,a),f=H(u.baseId,a),l=a===u.value,n=v.useRef(l);return v.useEffect(()=>{const b=requestAnimationFrame(()=>n.current=!1);return()=>cancelAnimationFrame(b)},[]),s.jsx(Z,{present:i||l,children:({present:b})=>s.jsx(w.div,{"data-state":l?"active":"inactive","data-orientation":u.orientation,role:"tabpanel","aria-labelledby":T,hidden:!b,id:f,tabIndex:0,...t,ref:r,style:{...e.style,animationDuration:n.current?"0s":void 0},children:b&&d})})});g.displayName=B;function K(e,r){return`${e}-trigger-${r}`}function H(e,r){return`${e}-content-${r}`}const $=C(D)`
  display: flex;
...
}`,...(V=(N=h.parameters)==null?void 0:N.docs)==null?void 0:V.source}}};const fe=["Default","Large","Inline"];export{p as Default,h as Inline,m as Large,fe as __namedExportsOrder,Te as default};
