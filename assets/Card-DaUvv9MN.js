...
`,L=i.div``,R=i.div``,A=i(C)`
  ...
  margin-top: 1rem;
`,o=Object.assign({},{Title:q,Content:j,LeftColumn:L,RightColumn:R,Actions:A}),S=({children:e,loading:n,error:m,info:l,size:$="md",...y})=>{let f,p,u,c,g;const z=x.Children.toArray(e).filter(t=>typeof t=="string"?!0:x.isValidElement(t)?t.type===o.Title?(f=t,!1):t.type===o.Content?(p=t,!1):t.type===o.LeftColumn?(c=t,!1):t.type===o.RightColumn?(g=t,!1):t.type===o.Actions?(u=t,!1):!0:!1);return d.jsxs(h,{$size:$,...y,children:[c,d.jsxs(T,{children:[f,p,u,z]}),g,(n||m||l)&&d.jsx(w,{error:m,info:l,children:typeof n=="string"?n:void 0})]})};S.__docgenInfo={description:"",methods:[],displayName:"Card",props:{className:{required:!1,tsType:{name:"string"},description:""},style:{required:!1,tsType:{name:"CSSProperties"},description:""},onClick:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},loading:{required:!1,tsType:{name:"union",raw:"string | boolean",elements:[{name:"string"},{name:"boolean"}]},description:""},error:{required:!1,tsType:{name:"union",raw:"string | boolean",elements:[{name:"string"},{name:"boolean"}]},description:""},info:{required:!1,tsType:{name:"union",raw:"string | boolean",elements:[{name:"string"},{name:"boolean"}]},description:""},size:{required:!1,tsType:{name:"CardSize"},description:"",defaultValue:{value:"CardSize.md",computed:!0}}},composes:["PropsWithChildren"]};export{S as C,o as a,v as b,h as c};
