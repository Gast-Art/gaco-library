...
`,v=({trigger:e,open:o,onOpenChange:r,title:s,content:a,children:n})=>{const[c,l]=i.useState(o),d=g=>{l(g),r==null||r(g)};return t.jsxs(Oe,{open:typeof o!==void 0?o:c,onOpenChange:d,children:[e&&t.jsx(Ne,{asChild:!0,children:e}),t.jsxs(be,{children:[t.jsx(Te,{}),t.jsx(Ie,{children:t.jsxs(J,{children:[t.jsx(Ae,{onClick:()=>d(!1),children:t.jsx(ge,{})}),s&&t.jsx(P.Title,{children:s}),a&&t.jsx(P.Content,{children:a}),n]})})]})]})};v.__docgenInfo={description:"",methods:[],displayName:"Dialog",props:{open:{required:!1,tsType:{name:"boolean"},description:""},onOpenChange:{required:!1,tsType:{name:"signature",type:"function",raw:"(open: boolean) => void",signature:{arguments:[{type:{name:"boolean"},name:"open"}],return:{name:"void"}}},description:""},trigger:{required:!1,tsType:{name:"ReactNode"},description:""},title:{required:!1,tsType:{name:"string"},description:""},content:{required:!1,tsType:{name:"ReactNode"},description:""}},composes:["PropsWithChildren"]};const Ye={title:"Molecules/Dialog",component:v,render:e=>{const[o,r]=i.useState(!1);return t.jsx(v,{...e,open:o,onOpenChange:r,trigger:t.jsx(F,{children:"Open dialog"})})},decorators:[e=>t.jsx("div",{style:{width:"480px",height:"320px"},children:t.jsx(e,{})})]},m={args:{title:"Dialog Title",content:"This is a dialog description.",children:t.jsx("p",{children:"This is the content of the dialog."})}},x={render:e=>t.jsx(v,{...e,trigger:t.jsx(F,{children:"Open dialog"})}),args:{...m.args}};var T,I,A;m.parameters={...m.parameters,docs:{...(T=m.parameters)==null?void 0:T.docs,source:{originalSource:`{
  args: {
    title: 'Dialog Title',
...
}`,...(w=(S=x.parameters)==null?void 0:S.docs)==null?void 0:w.source}}};const Ze=["Default","NoOutideState"];export{m as Default,x as NoOutideState,Ze as __namedExportsOrder,Ye as default};
