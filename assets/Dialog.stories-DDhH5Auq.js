...
`,C=({trigger:e,open:n,onOpenChange:r,title:s,content:a,children:t})=>o.jsxs(ye,{open:n,onOpenChange:r,children:[o.jsx(Re,{asChild:!0,children:e}),o.jsxs(_e,{children:[o.jsx(Ee,{}),o.jsx(Pe,{children:o.jsxs(X,{children:[o.jsx(Ne,{onClick:()=>r(!1),children:o.jsx(ce,{})}),s&&o.jsx(N.Title,{children:s}),a&&o.jsx(N.Content,{children:a}),t]})})]})]});C.__docgenInfo={description:"",methods:[],displayName:"Dialog",props:{trigger:{required:!0,tsType:{name:"ReactNode"},description:""},open:{required:!0,tsType:{name:"boolean"},description:""},onOpenChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(open: boolean) => void",signature:{arguments:[{type:{name:"boolean"},name:"open"}],return:{name:"void"}}},description:""},title:{required:!1,tsType:{name:"string"},description:""},content:{required:!1,tsType:{name:"string"},description:""}},composes:["PropsWithChildren"]};const He={title:"Molecules/Dialog",component:C,render:e=>{const[n,r]=i.useState(!1);return o.jsx(C,{...e,open:n,onOpenChange:r,trigger:o.jsx(se,{children:"Open dialog"})})},decorators:[e=>o.jsx("div",{style:{width:"480px",height:"320px"},children:o.jsx(e,{})})]},h={args:{title:"Dialog Title",content:"This is a dialog description.",children:o.jsx("p",{children:"This is the content of the dialog."})}};var T,O,I;h.parameters={...h.parameters,docs:{...(T=h.parameters)==null?void 0:T.docs,source:{originalSource:`{
  args: {
    title: 'Dialog Title',
