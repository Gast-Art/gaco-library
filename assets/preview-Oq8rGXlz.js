import{d as v}from"./index-ogSvIofg.js";import{R as r}from"./index-CZMpeKRu.js";import{f as b,o as O}from"./styled-components.browser.esm-BT5p091k.js";import{l as E,d as T}from"./light-CDswQMjI.js";const{useParameter:R,addons:P,useEffect:F,useMemo:k}=__STORYBOOK_MODULE_PREVIEW_API__,{deprecate:S}=__STORYBOOK_MODULE_CLIENT_LOGGER__;var x=Object.defineProperty,M=(e,t)=>{for(var o in t)x(e,o,{get:t[o],enumerable:!0})},a="themes",$=`storybook/${a}`,z="theme",u={},A={REGISTER_THEMES:`${$}/REGISTER_THEMES`},I={};M(I,{initializeThemeState:()=>_,pluckThemeFromContext:()=>f,useThemeParameters:()=>D});function f({globals:e}){return e[z]||""}function D(e){return S(v`The useThemeParameters function is deprecated. Please access parameters via the context directly instead e.g.
