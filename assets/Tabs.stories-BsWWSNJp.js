import{j as s}from"./jsx-runtime-CLpGMVip.js";import{r as v}from"./index-CR__hKHy.js";import{c as J,a as M,u as Q,b as U,d as W,P as w,R as X,I as Y,e as y,f as Z}from"./index-CdgiwGxL.js";import{d as C,l as x}from"./styled-components.browser.esm-DnH8uv-2.js";import"./index-D2e_E8nu.js";import"./index-CtmzRm2p.js";var S="Tabs",[ee,ue]=J(S,[M]),k=M(),[se,I]=ee(S),D=v.forwardRef((e,r)=>{const{__scopeTabs:n,value:a,onValueChange:i,defaultValue:d,orientation:t="horizontal",dir:u,activationMode:T="automatic",...f}=e,l=Q(u),[o,b]=U({prop:a,onChange:i,defaultProp:d});return s.jsx(se,{scope:n,baseId:W(),value:o,onValueChange:b,orientation:t,dir:l,activationMode:T,children:s.jsx(w.div,{dir:l,"data-orientation":t,...f,ref:r})})});D.displayName=S;var F="TabsList",O=v.forwardRef((e,r)=>{const{__scopeTabs:n,loop:a=!0,...i}=e,d=I(F,n),t=k(n);return s.jsx(X,{asChild:!0,...t,orientation:d.orientation,dir:d.dir,loop:a,children:s.jsx(w.div,{role:"tablist","aria-orientation":d.orientation,...i,ref:r})})});O.displayName=F;var G="TabsTrigger",q=v.forwardRef((e,r)=>{const{__scopeTabs:n,value:a,disabled:i=!1,...d}=e,t=I(G,n),u=k(n),T=K(t.baseId,a),f=H(t.baseId,a),l=a===t.value;return s.jsx(Y,{asChild:!0,...u,focusable:!i,active:l,children:s.jsx(w.button,{type:"button",role:"tab","aria-selected":l,"aria-controls":f,"data-state":l?"active":"inactive","data-disabled":i?"":void 0,disabled:i,id:T,...d,ref:r,onMouseDown:y(e.onMouseDown,o=>{!i&&o.button===0&&o.ctrlKey===!1?t.onValueChange(a):o.preventDefault()}),onKeyDown:y(e.onKeyDown,o=>{[" ","Enter"].includes(o.key)&&t.onValueChange(a)}),onFocus:y(e.onFocus,()=>{const o=t.activationMode!=="manual";!l&&!i&&o&&t.onValueChange(a)})})})});q.displayName=G;var B="TabsContent",g=v.forwardRef((e,r)=>{const{__scopeTabs:n,value:a,forceMount:i,children:d,...t}=e,u=I(B,n),T=K(u.baseId,a),f=H(u.baseId,a),l=a===u.value,o=v.useRef(l);return v.useEffect(()=>{const b=requestAnimationFrame(()=>o.current=!1);return()=>cancelAnimationFrame(b)},[]),s.jsx(Z,{present:i||l,children:({present:b})=>s.jsx(w.div,{"data-state":l?"active":"inactive","data-orientation":u.orientation,role:"tabpanel","aria-labelledby":T,hidden:!b,id:f,tabIndex:0,...t,ref:r,style:{...e.style,animationDuration:o.current?"0s":void 0},children:b&&d})})});g.displayName=B;function K(e,r){return`${e}-trigger-${r}`}function H(e,r){return`${e}-content-${r}`}const R=C(D)`
  display: flex;
